...
public class JfrEstudiantes extends javax.swing.JFrame {
    ...
    private void reportParam() {
        ...
        try {
            JasperReport report = JasperCompileManager.compileReport("src\\Reporte\\maestro.jrxml");
    ...
    private void generarReporte(){
        ...
        base.setCon();
        try {
            JasperReport report = JasperCompileManager.compileReport("src\\Reporte\\Grafico.jrxml");
